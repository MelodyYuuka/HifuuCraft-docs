...
![TUI示例](/images/servers/1.png)

@tab CUI

![CUI示例](/images/servers/4.png)

:::

在聊天栏中输入你要创建的领地名称：

![输入领地名称](/images/servers/2.png)

输入完成后回车发送，即可以你为中心自动创建一块领地：

![回车发送](/images/servers/3.png)
...
![TUI示例](/images/servers/dominion_pt2/1.png)

@tab CUI

![CUI示例](/images/servers/dominion_pt2/4.png)
...
![TUI示例](/images/servers/dominion_pt2/2.png)

@CUI

![CUI示例](/images/servers/dominion_pt2/5.png)
...
![](/images/servers/dominion_pt2/3.png)

@CUI

![](/images/servers/dominion_pt2/6.png)
...
![](/images/servers/dominion_pt3/1.png)

@tab CUI

![](/images/servers/dominion_pt3/3.png)
...
![绿色的 ☑ 表示启用，红色的 ☐ 表示禁用，将鼠标移动到对应权限上会显示权限描述。](/images/servers/dominion_pt3/2.png)

@tab CUI

![绿色的 ✔ 表示启用，红色的 ✘ 表示禁用，将鼠标移动到对应权限上会显示权限描述。](/images/servers/dominion_pt3/4.png)
...
:::tabs
@tab TUI
![](/images/servers/dominion_pt4/1.png)
@tab CUI
![](/images/servers/dominion_pt4/3.png)
:::
...
![](/images/servers/dominion_pt4/2.png)

@tab CUI

绿色的 ✔ 表示启用，红色的 ✘ 表示禁用，将鼠标移动到对应权限上会显示权限描述。
![](/images/servers/dominion_pt4/4.png)
...
![](/images/servers/dominion_pt5/1.png)
![](/images/servers/dominion_pt5/2.png)

若要修改领地的尺寸可以点击尺寸信息页面的 `【修改大小】`，随后即可打开大小修改页面：

![](/images/servers/dominion_pt5/3.png)

@tab CUI

打开对应领地的管理页面，鼠标移动到领地概览，可以查看当前领地的尺寸信息：

![](/images/servers/dominion_pt5/5.png)

点击领地概览可以打开修改领地尺寸的页面：

![](/images/servers/dominion_pt5/6.png)

:::

例如我现在希望将领地向北扩张10格，那么点击 `北（Z-）【扩张】` 随后在聊天栏中输入要扩张的格数 `10`：

![](/images/servers/dominion_pt5/4.png)
...
![](/images/servers/dominion_pt6/1.png)

### 提示消息

玩家在进入或离开领地的时候可以看到一则提示消息，通过此消息可以提示玩家当前所在的领地：

![](/images/servers/dominion_pt6/2.png)

要设置提示消息可以在领地管理界面点击 `【进入提示】` 或 `【离开提示】`，分别设置当玩家进入或者离开领地时看到的消息：

![](/images/servers/dominion_pt6/3.png)
![](/images/servers/dominion_pt6/4.png)
...
![](/images/servers/dominion_pt6/5.png)

颜色需要为 `#` 开头的十六进制颜色值，例如 `#FF0000` 表示红色，`#00FF00` 表示绿色，`#0000FF` 表示蓝色， 可使用一些在线颜色选择器来寻找喜欢颜色的对应值。

## 删除领地

由于删除领地是一个相对危险的操作，因此虽然在领地列表提供了删除领地的按钮，但是直接点击是无法成功删除的：

![](/images/servers/dominion_pt7/1.png)
...
![](/images/servers/dominion_pt10/1.png)
![](/images/servers/dominion_pt10/2.png)

### 为领地添加成员

在成员列表点击`【添加成员】`：

![](/images/servers/dominion_pt11/1.png)

会出现所有登陆过服务器的玩家名称，点击玩家名称即可将其添加为领地成员：

![](/images/servers/dominion_pt11/2.png)

如果玩家太多，在列表中寻找起来太困难，可以点击玩家列表上的`【搜索】`直接输入玩家游戏昵称添加：

![](/images/servers/dominion_pt11/3.png)
...
![](/images/servers/dominion_pt12/1.png)
![](/images/servers/dominion_pt12/2.png)

### 从领地移除成员

要想将一个成员移出领地，在成员列表点击对应成员前的`【移除】`即可：

![](/images/servers/dominion_pt13/1.png)
...
![](/images/servers/dominion_pt14/1.png)

点击列表顶部的`【创建】`，根据提示输入模板名称即可创建一个权限模板：

![](/images/servers/dominion_pt14/2.png)

![](/images/servers/dominion_pt14/3.png)

配置
在模板列表点击对应模板前的`【设置】`即可设置此模板的权限配置：

![](/images/servers/dominion_pt14/4.png)

![](/images/servers/dominion_pt14/5.png)

使用
配置完模板后即可套用到其他玩家身上，在对应玩家的权限配置页面点击`【套用模板】`：

![](/images/servers/dominion_pt14/6.png)

随后即可看到刚才创建的权限模板，点击要使用的模板前的`【套用】`，即可将模板的权限组合应用到此玩家身上：

![](/images/servers/dominion_pt14/7.png)
...
![](/images/servers/dominion_pt15/1.png)

![](/images/servers/dominion_pt15/2.png)

### 为领地创建权限组

在权限组列表页面，点击页面顶部的`【创建】`，按照提示输入权限组名称即可创建：

![](/images/servers/dominion_pt16/1.png)

![](/images/servers/dominion_pt16/2.png)

### 添加成员到权限组

点击对应权限组后面的`【+】`进入选择成员页面：

![](/images/servers/dominion_pt17/1.png)

点击要添加到权限组的领地成员，即可：

![](/images/servers/dominion_pt17/2.png)

![](/images/servers/dominion_pt17/3.png)
...
![](/images/servers/dominion_pt18/1.png)

### 删除权限组

在权限组列表中找到要删除的权限组，点击权限组前的【删除】即可删除权限组：

![](/images/servers/dominion_pt19/1.png)

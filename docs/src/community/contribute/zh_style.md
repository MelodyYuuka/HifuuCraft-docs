...
:::tip
本页面所用术语可从 [术语表 > 文档相关](../../reference/glossary.md#文档相关) 中查询
:::

## 中文写作排版风格指南

### [**CJK**](../../reference/glossary.md#CJK) 与 [**西文**](../../reference/glossary.md#西文) 之间一律插入一个空格
...
### CJK与 [**西文符号**](../../reference/glossary.md#西文符号) 之间加空格
...
```diff:no-line-numbers
- 可以查询[术语表](../../reference/glossary.md)来找到相关信息
+ 可以查询 [术语表](../../reference/glossary.md) 来找到相关信息
```
